                ...
                <table className="table" style={{width: "500px"}}>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="password" className="form-control" required style={{width: "120px"}}
                        ...
                        <tr>
                            <td colSpan={2} align="center">
                                <button type="submit" className="btn btn-outline-info" style={{width:"100px"}} onClick={onSubmitEvent}>가입하기</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
