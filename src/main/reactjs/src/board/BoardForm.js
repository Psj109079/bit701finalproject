        ...
        <div style={{marginLeft: "100px", width: "400px"}}>
            <form onSubmit={onSubmitEvent}>
                <table className="table">
                    ...
                    <tbody>
                        <tr>
                            <th style={{backgroundColor: "#dddddd", width: "100px"}}>제목</th>
                            <td>
                        ...
                        <tr>
                            <th style={{backgroundColor: "#dddddd", width: "100px"}}>사진</th>
                            <td>
                                <input type="file" className="form-control" onChange={onUploadEvent}/>
                            </td>
                        </tr>
                        <tr>
                            <th style={{backgroundColor: "#dddddd", width: "100px"}}>내용</th>
                            <td>
                                <textarea style={{width: "100%", height: "100px"}} required value={content}
            ...
            <img alt="" src={`${photoUrl}${photo}`} style={{width: "200px", position: "absolute", left: "700px", top: "100px"}}/>
        </div>
    );
}
